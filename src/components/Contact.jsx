...
//       <main className=" flex flex-col justify-center px-4 py-12 gap-8">
//         <h1 className="font-nasalizationg text-center text-white space-y-2 md:space-y-4 text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-tight md:leading-snug font-extrabold tracking-wide uppercase ">
//           CONNECT WITH US
//         </h1>
...
//               placeholder="*Name"
//               required
//               className="bg-transparent border border-gray-600 rounded-md py-3 px-4 focus:outline-none focus:border-teal-400 placeholder-gray-500"
//             />
//             <input
//               type="email"
//               placeholder="*Email"
...
//               placeholder="Message"
//               rows={6}
//               className="bg-transparent border border-gray-600 rounded-md py-3 px-4 focus:outline-none focus:border-teal-400 placeholder-gray-500 resize-none"
//             />

//             <button
//               type="submit"
//               className="self-center border border-white hover:bg-white/30 rounded-tr-3xl rounded-bl-3xl py-2 px-16 "
//             >
//               Send
//             </button>
//           </form>
